...
int minix_dir_readdir(struct inode *, struct fd *, struct dirent *, __size_t);
...
int iso9660_dir_readdir(struct inode *, struct fd *, struct dirent *, __size_t);
...
int procfs_dir_readdir(struct inode *, struct fd *, struct dirent *, __size_t);
