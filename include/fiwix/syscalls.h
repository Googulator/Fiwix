...
int sys_getpid(void);
int sys_mount(const char *, const char *, const char *, unsigned long int, const void *);
...
int old_select(unsigned long int *);
...
int sys_socketcall(int, unsigned long int *);
...
int sys_personality(unsigned long int);
